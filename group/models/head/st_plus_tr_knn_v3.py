...
from group.models.transformer_v4 import TransformerEncoderLayer, TransformerEncoder, TransformerDecoderLayer2, TransformerDecoder,TransformerDecoderLayer
...
class ST_plus_TR_knn_v3(nn.Module):
    def __init__(self,config):
        super(ST_plus_TR_knn_v3, self).__init__()
